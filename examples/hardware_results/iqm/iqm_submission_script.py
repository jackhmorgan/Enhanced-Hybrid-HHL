...
for iteration in range(3,6):
    for i, problem in enumerate(problem_list):    
        ...
        #canonical_results.append(canonical_result.circuit_results.result().quasi_dists[0])
        ...
        #hybrid_results.append(hybrid_result.circuit_results.result().quasi_dists[0])
        ...
        #enhanced_results.append(enhanced_result.circuit_results.result().quasi_dists[0])
